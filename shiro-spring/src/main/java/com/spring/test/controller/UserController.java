...
import com.spring.test.pagemodel.DataGrid;
import com.spring.test.pagemodel.MSG;
import com.spring.test.pagemodel.UserInfo;
import com.spring.test.pagemodel.UserValidate;
...
public class UserController {
	...
	public Set<String> getpermissions(){
	 ...
	 public MSG login(@RequestBody UserValidate userValidate) {
	       ...
	       if(!rand.equalsIgnoreCase(userValidate.getCode())){
		   ...
		   try {
			   ...
			   return msg;
				...
				MSG msg=new MSG("error user");
				return msg;
			} catch ( IncorrectCredentialsException ice ) {
				MSG msg=new MSG("error pwd");
				return msg;
